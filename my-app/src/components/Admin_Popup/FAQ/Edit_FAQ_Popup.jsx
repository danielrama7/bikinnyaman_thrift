...
export default function Edit_FAQ_Popup(ph1, ph2, close) {
  return (
    <div className="modalAdmin">
      <div className="bg-white border border-gray-400 rounded-md p-4 w-[450px]">
        <div className="flex justify-between">
          <div>
            <h1 className="text-lg text-gray-500">Edit FAQ</h1>
          </div>
        ...
        <div className="w-full">
          ...
          <textarea
            className="w-full px-3 py-2 text-gray-600 border rounded border-gray-200 mt-2"
            rows="3"
            placeholder={ph2}
          ></textarea>
        </div>
